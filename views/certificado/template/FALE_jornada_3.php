...
<div style="text-align: center">
  ...
  <div class="col-xs-3">
        ...
        <div class="col-xs-4">
            <img  width="60%" src="img/UniversidadPublica.png" alt="UniversidadPublica"/></div>
            
            <div class="col-xs-3">
            <img  width="60%" src="img/uncomarecortado.png" alt="UNCo"/></div>            
    ...
    <h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b>, DNI Nº <b><?=$model->idPersona0->getDnioIdExt()?></b><br/>
