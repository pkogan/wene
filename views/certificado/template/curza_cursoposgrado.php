...
<!--<img  src="img/uncoma150.png" alt="UNCo"/>
 ...
 <div class="row" >
        ...
        <div class="col-xs-12">
            <img  src="img/curza.png" width="10%" alt="UNCo"/></div>
...
<!--        <div class="col-xs-5">
    ...
    <h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b>, DNI Nº <b><?= number_format($model->idPersona0->dni,0,',','.'); ?></b><br/>
        <b><?= $model->idLote0->idTipoCertificado0->tipo ?></b> con una calificación final de <b><?=$model->observacion?></b> <?=$model->idLote0->getConector() ?> <b><?= $model->idLote0->idActividad0->idTipoActividad0->tipo ?></b>
        <b>"<?= $model->idLote0->idActividad0->nombre ?>"</b> con una duración de <?=$model->idLote0->idActividad0->duracion.$model->idLote0->idActividad0->medidaDuracion?>, avalado por <?= $model->idLote0->idActividad0->norma?>.
