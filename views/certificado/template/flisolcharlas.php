...
<!--    <div style="background:linear-gradient(rgba(255,255,255,.9), rgba(255,255,255,.8))">-->
  ...
  <div class="row" >
        ...
        <div class="col-xs-3">
            <img  src="img/uncomarecortado.png" height="165px" alt="UNCo"/></div>
        <div class="col-xs-4">
...
<!--                <h3>Facultad de Informática Universidad Nacional del Comahue</h3>-->
        ...
        <h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b>, <b><?=$model->idPersona0->getDnioIdExt()?></b> <?=$model->observacion?>
