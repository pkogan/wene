...
<div style="text-align: center">
    ...
    <div class="row" >
       ...
       <div class="col-xs-4">
            <img  width="100%" src="img/OEUNCo.png" alt="Observatorio"/></div>
        <div class="col-xs-3">
            <img  width="70%" src="img/uncomarecortado.png" alt="UNCo"/>
        </div>
           <div class="col-xs-3">
            <img  width="100%" src="img/40ADTransparente.png" alt="40 años Democracia"/></div>
    ...
    <h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre, 'UTF-8'); ?></b>, DNI Nº <b><?= number_format($model->idPersona0->dni, 0, ',', '.'); ?></b><br/>
        cumplió el rol de <b><?= mb_strtoupper($model->idLote0->idTipoCertificado0->tipo) ?></b> <?= $model->idLote0->getConector() ?> <!--<?= $model->idLote0->idActividad0->idTipoActividad0->tipo ?>-->
