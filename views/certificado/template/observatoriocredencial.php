...
<!--    <h4>Apellido y Nombre</h4>-->
    <h1> <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b></h1>
    
    
    <h1><b><?= $model->idPersona0->getDnioIdext();//number_format($model->idPersona0->dni,0,',','.'); ?></b></h1>
<!--    <h4>DNI</h4>-->
    <hr/>
    <br/>
        ...
        <b><?= mb_strtoupper($model->idLote0->idActividad0->nombre) ?></b></h1>
            
            <h1><?= $model->idLote0->getFechaTexto(); ?></h1>
...
<img  width="150px" src="<?= $qrCode->writeDataUri() ?>" >                        
