...
<!--<p>
    ...
    <div style='text-align: center; background: url(img/CNE2023/templateCNEBalotaje2023.png);  background-repeat: no-repeat;  background-size: 800px '>
    <br>
    <br>
    <br>
...
<br>
    ...
    <div >
        <br/>
    <img src="img/CNE2023/detrasCNE2023.png"></img>
</div>
