...
<div style='text-align: center; background: url(img/pagagonialibreredondo_.png) ; background-size: contain; background-position: center'>
 ...
 <div class="col-xs-2">
       ...
       <div class="col-xs-2"><img  width="80%"  src="img/san-juan-bosco.png" alt="SJB"/></div>
        <div class="col-xs-2">
            <img   src="img/pagagonialibreredondo.png" alt="patagonialibre"/></div>
        
        <div class="col-xs-2">
             <img width="60%" src="img/UNPA.jpg" alt="UNPA"/></div>
       <div class="col-xs-2">
           <img  width="90%" src="img/tierradelfuego.png" alt="patagonialibre"/>
       <img   src="img/diputadossantacruz.png" alt="patagonialibre"/></div>
...
<h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b> <?=($model->idPersona0->dni>0)?", DNI Nº <b>". number_format($model->idPersona0->dni,0,',','.').'</b>':'' ?>
