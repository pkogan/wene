...
<!--<img  src="img/uncoma150.png" alt="UNCo"/>
    ...
    <div class="col-xs-4">
        ...
        <div class="col-xs-3">
            <img  src="img/patagonian.png" alt="Sadosky"/></div>
    ...
    <h3>Se certifica que <b><?= $model->idPersona0->apellidoNombre; ?></b>, DNI Nº <b><?= number_format($model->idPersona0->dni,0,',','.'); ?></b><br/>
        <b><?= $model->idLote0->idTipoCertificado0->tipo ?></b> <?=$model->idLote0->idTipoCertificado0->conectorF ?> <b><?= $model->idLote0->idActividad0->idTipoActividad0->tipo ?></b>
