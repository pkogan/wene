...
<!--    <div style="background:linear-gradient(rgba(255,255,255,.9), rgba(255,255,255,.8))">-->
 ...
 <div class="col-xs-6">
            <img   width="30%" src="img/uncomarecortado.png" alt="UNCo"/></div>
...
<!--                <h3>Facultad de Informática Universidad Nacional del Comahue</h3>-->
        ...
        <h3>Se certifica que <b><?= mb_strtoupper($model->idPersona0->apellidoNombre,'UTF-8'); ?></b>, DNI Nº <b><?= number_format($model->idPersona0->dni,0,',','.') ?></b> <?=$model->observacion?>
